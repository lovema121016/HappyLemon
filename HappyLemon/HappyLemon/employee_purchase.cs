...
{
    public partial class employee_purchase : Form
    {
        public purchaseOrder purchase;
        public purchaseReturn1 purchase_return;
        public purchaseSale sale;
        public string type;
        public employee_purchase()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.type == "购货订单")
            {
                purchase.textBox3.Text = dataGridView1.Rows[r].Cells[1].Value.ToString() + " " + dataGridView1.Rows[r].Cells[2].Value.ToString();
                this.Close();
            }
            else if (this.type == "购货退货单")
            {
                purchase_return.textBox3.Text = dataGridView1.Rows[r].Cells[1].Value.ToString() + " " + dataGridView1.Rows[r].Cells[2].Value.ToString();
                this.Close();
            }
            else if (this.type == "销货订单")
            {
                sale.textBox3.Text = dataGridView1.Rows[r].Cells[1].Value.ToString() + " " + dataGridView1.Rows[r].Cells[2].Value.ToString();
                this.Close();
            }
        }
    }
