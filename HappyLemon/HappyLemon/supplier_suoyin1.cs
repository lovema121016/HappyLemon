...
{
    public partial class supplier_suoyin1 : Form
    {
            ...
            for (int i = 0; i < data.Rows.Count; i++)
            {
                ...
                try
                {
                    if (Convert.ToBoolean(this.data.Rows[i].Cells[0].Value) == true)
                    {
                         ...
                         if(this.type=="退款单")
                        {
                           tuikuan.textBox1.Text = data.Rows[i].Cells[2].Value.ToString() + " " + data.Rows[i].Cells[3].Value.ToString();
                            this.Close();
                        }
                        else if(this.type=="付款单")
                        {
                            fukuan.textBox1.Text = data.Rows[i].Cells[2].Value.ToString() + " " + data.Rows[i].Cells[3].Value.ToString();
                            this.Close();
                        }
                    }
                }
        ...
        private void supplier_suoyin1_Load(object sender, EventArgs e)
        {
